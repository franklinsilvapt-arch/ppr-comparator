...
from scrapers import yahoo, investing, golden_sgf, sites, ft
import calc_metrics
...
def main():
    ...
    print("\n== FINANCIAL TIMES ==")
    fetched_so_far = set(yahoo_data) | set(investing_data) | set(sgf_data)
    ft_data = ft.run(funds, already_fetched=fetched_so_far)

    all_prices = {**yahoo_data, **investing_data, **sgf_data, **ft_data}
